...
//Amanah
//SLLC.cpp
//program singgle linked list circular dengan head dan tail dengan tambahan function mencari data tertentu dan menghapus data tertentu
...
void tampilData() {
    ...
    if (is Empty() == 0) {
        ...
        cout << "List masuk kosong" << endl;
    }
}

void cariData (int cari) {
    TNode *nodeBantu;       //bool ketemu = false;
    nodeBantu = head;
        if (isEmpty() != 1) {
         while (nodeBantu != NULL) {
             if (nodeBantu->data == cari) {     //ketemu = true;
        ...
        int main() {
            ...
            do {
                ...
                if (pil == 1) {
                    ...
                    cout << "\n maaf, pilihan yang anada pilih tidak tersedia!";
                }
            } while (pil != 9);
